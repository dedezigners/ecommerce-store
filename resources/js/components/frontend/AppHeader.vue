			...
			<div class="container">
				<div class="row small-gutters">
					...
					<nav class="col-xl-6 col-lg-7">
						...
						<div class="main-menu">
							<div id="header_menu">
								<a href="/"><img src="/assets/template/img/logo_black.svg" alt="" width="100" height="35"></a>
										...
										<ul>
											<li>
												<a href="product-detail-1.html">
													<figure><img src="/assets/template/img/products/product_placeholder_square_small.jpg" data-src="/assets/template/img/products/shoes/thumb/1.jpg" alt="" width="50" height="50" class="lazy"></figure>
											...
											<li>
												<a href="product-detail-1.html">
													<figure><img src="/assets/template/img/products/product_placeholder_square_small.jpg" data-src="/assets/template/img/products/shoes/thumb/2.jpg" alt="" width="50" height="50" class="lazy"></figure>
