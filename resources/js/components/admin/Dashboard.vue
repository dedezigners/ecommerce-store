...
export default {
  ...
  data () {
    return {
      ...
      tableItems: [
        {
          avatar: { url: '/assets/admin/img/avatars/1.jpg', status: 'success' },
        ...
        {
          avatar: { url: '/assets/admin/img/avatars/2.jpg', status: 'danger' },
        ...
        {
          avatar: { url: '/assets/admin/img/avatars/3.jpg', status: 'warning' },
        ...
        {
          avatar: { url: '/assets/admin/img/avatars/4.jpg', status: '' },
        ...
        {
          avatar: { url: '/assets/admin/img/avatars/5.jpg', status: 'success' },
        ...
        {
          avatar: { url: '/assets/admin/img/avatars/6.jpg', status: 'danger' },
