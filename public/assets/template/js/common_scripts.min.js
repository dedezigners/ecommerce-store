...
function _typeof(t) {
    ...
    T.fn = T.prototype = {
        ...
        for ("boolean" == typeof s && (c = s, s = arguments[a] || {}, a++), "object" == typeof s || _(s) || (s = {}), a === l && (s = this, a--); a < l; a++)
            if (null != (t = arguments[a]))
                for (e in t) n = s[e], s !== (i = t[e]) && (c && i && (T.isPlainObject(i) || (o = Array.isArray(i))) ? (r = o ? (o = !1, n && Array.isArray(n) ? n : []) : n && T.isPlainObject(n) ? n : {}, s[e] = T.extend(c, r, i)) : void 0 !== i && (s[e] = i));
        return s
    }, T.extend({
    ...
    var f = function(n) {
            ...
            if (!i && ((e ? e.ownerDocument || e : _) !== x && C(e), e = e || x, E)) {
                if (11 !== d && (l = J.exec(t)))
                    if (o = l[1]) {
                        ...
                        if ((o = l[3]) && f.getElementsByClassName && e.getElementsByClassName) return L.apply(n, e.getElementsByClassName(o)), n
        ...
        for (t in f = rt.support = {}, s = rt.isXML = function(t) {
                ...
                return i !== x && 9 === i.nodeType && i.documentElement && (a = (x = i).documentElement, E = !s(x), _ !== x && (n = x.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", o, !1) : n.attachEvent && n.attachEvent("onunload", o)), f.attributes = lt(function(t) {
                ...
                }), m = m.length && new RegExp(m.join("|")), u = u.length && new RegExp(u.join("|")), e = G.test(a.compareDocumentPosition), y = e || G.test(a.contains) ? function(t, e) {
                ...
                var n = b.attrHandle[e.toLowerCase()],
                    i = n && N.call(b.attrHandle, e.toLowerCase()) ? n(t, e, !E) : void 0;
                ...
                preFilter: {
                    ...
                    PSEUDO: function(t) {
                        var e, n = !t[6] && t[2];
                        return Y.CHILD.test(t[0]) ? null : (t[3] ? t[2] = t[4] || t[5] || "" : n && K.test(n) && (e = p(n, !0)) && (e = n.indexOf(")", n.length - e) - n.length) && (t[0] = t[0].slice(0, e), t[2] = n.slice(0, e)), t.slice(0, 3))
                    }
                },
                filter: {
                    TAG: function(t) {
        ...
        return mt.prototype = b.filters = b.pseudos, b.setFilters = new mt, p = rt.tokenize = function(t, e) {
            ...
            if (n = n || [], 1 === u.length) {
                ...
                for (o = Y.needsContext.test(t) ? 0 : r.length; o-- && (s = r[o], !b.relative[a = s.type]);)
                    if ((l = b.find[a]) && (i = l(s.matches[0].replace(et, h), tt.test(r[0].type) && gt(e.parentNode) || e))) {
                        if (r.splice(o, 1), !(t = i.length && vt(r))) return L.apply(n, i), n;
                        break
                    }
            }
            return (c || d(t, u))(i, e, !E, n, !e || tt.test(t) && gt(e.parentNode) || e), n
        }, f.sortStable = T.split("").sort(I).join("") === T, f.detectDuplicates = !!c, C(), f.sortDetached = lt(function(t) {
    ...
    (T.fn.init = function(t, e, n) {
        ...
        if (i[1]) {
            if (e = e instanceof T ? e[0] : e, T.merge(this, T.parseHTML(i[1], e && e.nodeType ? e.ownerDocument || e : E, !0)), A.test(i[1]) && T.isPlainObject(e))
    ...
    T.fn.extend({
        ...
        contents: function(t) {
            return k(t, "iframe") ? t.contentDocument : (k(t, "template") && (t = t.content || t), T.merge([], t.childNodes))
        }
    }, function(i, o) {
        T.fn[i] = function(t, e) {
    ...
    }), T.ready.then = q.then, "complete" === E.readyState || "loading" !== E.readyState && !E.documentElement.doScroll ? x.setTimeout(T.ready) : (E.addEventListener("DOMContentLoaded", R), x.addEventListener("load", R));
    ...
    function vt(t, e, n, i, o) {
        for (var r, s, a, l, c, u, h = e.createDocumentFragment(), d = [], f = 0, p = t.length; f < p; f++)
            ...
            for (s = s || h.appendChild(e.createElement("div")), a = (ct.exec(r) || ["", ""])[1].toLowerCase(), l = ht[a] || ht._default, s.innerHTML = l[1] + T.htmlPrefilter(r) + l[2], u = l[0]; u--;) s = s.lastChild;
            T.merge(d, s.childNodes), (s = h.firstChild).textContent = ""
        } else d.push(e.createTextNode(r));
        for (h.textContent = "", f = 0; r = d[f++];)
            if (i && -1 < T.inArray(r, i)) o && o.push(r);
            else if (c = T.contains(r.ownerDocument, r), s = dt(h.appendChild(r), "script"), c && ft(s), n)
            for (u = 0; r = s[u++];) ut.test(r.type || "") && n.push(r);
        return h
    }
    pt = E.createDocumentFragment().appendChild(E.createElement("div")), (gt = E.createElement("input")).setAttribute("type", "radio"), gt.setAttribute("checked", "checked"), gt.setAttribute("name", "t"), pt.appendChild(gt), y.checkClone = pt.cloneNode(!0).cloneNode(!0).lastChild.checked, pt.innerHTML = "<textarea>x</textarea>", y.noCloneChecked = !!pt.cloneNode(!0).lastChild.defaultValue;
    ...
    T.event = {
        ...
        add: function(e, t, n, i, o) {
            ...
            if (m)
                for (n.handler && (n = (r = n).handler, o = r.selector), o && T.find.matchesSelector(yt, o), n.guid || (n.guid = T.guid++), (l = m.events) || (l = m.events = {}), (s = m.handle) || (s = m.handle = function(t) {
                        return void 0 !== T && T.event.triggered !== t.type ? T.event.dispatch.apply(e, arguments) : void 0
                    }), c = (t = (t || "").match(j) || [""]).length; c--;) f = g = (a = wt.exec(t[c]) || [])[1], p = (a[2] || "").split(".").sort(), f && (h = T.event.special[f] || {}, f = (o ? h.delegateType : h.bindType) || f, h = T.event.special[f] || {}, u = T.extend({
                    type: f,
                    origType: g,
                    data: i,
                    handler: n,
    ...
    function Lt(n, i, o, r) {
        ...
        if (h && (e = (t = vt(i, n[0].ownerDocument, !1, n, r)).firstChild, 1 === t.childNodes.length && (t = e), e || r)) {
            for (a = (s = T.map(dt(t, "script"), Nt)).length; u < h; u++) l = t, u !== d && (l = T.clone(l, !0, !0), a && T.merge(s, dt(l, "script"))), o.call(n[u], l, u);
            if (a)
                for (c = s[s.length - 1].ownerDocument, T.map(s, Ot), u = 0; u < a; u++) l = s[u], ut.test(l.type || "") && !Y.access(l, "globalEval") && T.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? T._evalUrl && T._evalUrl(l.src) : b(l.textContent.replace(Dt, ""), c, l))
        }
        return n
    }

    function jt(t, e, n) {
        for (var i, o = e ? T.filter(e, t) : t, r = 0; null != (i = o[r]); r++) n || 1 !== i.nodeType || T.cleanData(dt(i)), i.parentNode && (n && T.contains(i.ownerDocument, i) && ft(dt(i, "script")), i.parentNode.removeChild(i));
        return t
    }
    T.extend({
        ...
        clone: function(t, e, n) {
            ...
            if (!(y.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || T.isXMLDoc(t)))
                for (s = dt(u), i = 0, o = (r = dt(t)).length; i < o; i++) a = r[i], l = s[i], "input" === (c = l.nodeName.toLowerCase()) && lt.test(a.type) ? l.checked = a.checked : "input" !== c && "textarea" !== c || (l.defaultValue = a.defaultValue);
            if (e)
                if (n)
                    for (r = r || dt(t), s = s || dt(u), i = 0, o = r.length; i < o; i++) Pt(r[i], s[i]);
                else Pt(t, u);
    ...
    var Mt, Ht, $t, zt, qt, Rt, Wt, Ft = new RegExp("^(" + et + ")(?!px)[a-z%]+$", "i"),
        Bt = function(t) {
    ...
    function Qt() {
        if (Wt) {
            Rt.style.cssText = "position:absolute;left:-11111px;width:60px;margin-top:1px;padding:0;border:0", Wt.style.cssText = "position:relative;display:block;box-sizing:border-box;overflow:scroll;margin:auto;border:1px;padding:1px;width:60%;top:1%", yt.appendChild(Rt).appendChild(Wt);
            var t = x.getComputedStyle(Wt);
            Mt = "1%" !== t.top, qt = 12 === Kt(t.marginLeft), Wt.style.right = "60%", zt = 36 === Kt(t.right), Ht = 36 === Kt(t.width), Wt.style.position = "absolute", $t = 36 === Wt.offsetWidth || "absolute", yt.removeChild(Rt), Wt = null
        }
    }
    ...
    function Vt(t, e, n) {
        ...
        return (n = n || Bt(t)) && ("" !== (s = n.getPropertyValue(e) || n[e]) || T.contains(t.ownerDocument, t) || (s = T.style(t, e)), !y.pixelBoxStyles() && Ft.test(s) && Ut.test(e) && (i = a.width, o = a.minWidth, r = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = o, a.maxWidth = r)), void 0 !== s ? s + "" : s
    }
    ...
    Rt = E.createElement("div"), (Wt = E.createElement("div")).style && (Wt.style.backgroundClip = "content-box", Wt.cloneNode(!0).style.backgroundClip = "", y.clearCloneStyle = "content-box" === Wt.style.backgroundClip, T.extend(y, {
    ...
    function oe(t, e, n, i, o, r) {
        ...
        for (; s < 4; s += 2) "margin" === n && (l += T.css(t, n + it[s], !0, o)), i ? ("content" === n && (l -= T.css(t, "padding" + it[s], !0, o)), "margin" !== n && (l -= T.css(t, "border" + it[s] + "Width", !0, o))) : (l += T.css(t, "padding" + it[s], !0, o), "padding" !== n ? l += T.css(t, "border" + it[s] + "Width", !0, o) : a += T.css(t, "border" + it[s] + "Width", !0, o));
    ...
    function re(t, e, n) {
        ...
        return s = s && (y.boxSizingReliable() || o === t.style[e]), "auto" !== o && (parseFloat(o) || "inline" !== T.css(t, "display", !1, i)) || (o = t["offset" + e[0].toUpperCase() + e.slice(1)], s = !0), (o = parseFloat(o) || 0) + oe(t, e, n || (r ? "border" : "content"), s, i, o) + "px"
    }
    ...
    T.extend({
        ...
        style: function(t, e, n, i) {
            if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                ...
                "string" == (r = typeof n) && (o = nt.exec(n)) && o[1] && (n = rt(t, e, o), r = "number"), null != n && n == n && ("number" === r && (n += o && o[3] || (T.cssNumber[a] ? "" : "px")), y.clearCloneStyle || "" !== n || 0 !== e.indexOf("background") || (c[e] = "inherit"), s && "set" in s && void 0 === (n = s.set(t, n, i)) || (l ? c.setProperty(e, n) : c[e] = n))
            }
        },
        css: function(t, e, n, i) {
            var o, r, s, a = Q(e);
            return Zt.test(e) || (e = ne(a)), (s = T.cssHooks[e] || T.cssHooks[a]) && "get" in s && (o = s.get(t, !0, n)), void 0 === o && (o = Vt(t, e, i)), "normal" === o && e in Jt && (o = Jt[e]), "" === n || n ? (r = parseFloat(o), !0 === n || isFinite(r) ? r || 0 : o) : o
        }
        ...
        T.cssHooks[a] = {
            ...
            set: function(t, e, n) {
                var i, o = Bt(t),
                    ...
                    s = n && oe(t, a, n, r, o);
                return r && y.scrollboxSize() === o.position && (s -= Math.ceil(t["offset" + a[0].toUpperCase() + a.slice(1)] - parseFloat(o[a]) - oe(t, a, "border", !1, o) - .5)), s && (i = nt.exec(e)) && "px" !== (i[3] || "px") && (t.style[a] = e, e = T.css(t, a)), ie(0, e, s)
            }
        }
    ...
    var ae, le, ce, ue, he = /^(?:toggle|show|hide)$/,
        de = /queueHooks$/;

    function fe() {
        le && (!1 === E.hidden && x.requestAnimationFrame ? x.requestAnimationFrame(fe) : x.setTimeout(fe, T.fx.interval), T.fx.tick())
    }
    ...
    function me(t, e, n) {
        for (var i, o = (ve.tweeners[e] || []).concat(ve.tweeners["*"]), r = 0, s = o.length; r < s; r++)
    ...
    function ve(r, t, e) {
        ...
        return T.map(u, me, c), _(c.opts.start) && c.opts.start.call(r, c), c.progress(c.opts.progress).done(c.opts.done, c.opts.complete).fail(c.opts.fail).always(c.opts.always), T.fx.timer(T.extend(l, {
            elem: r,
            anim: c,
            queue: c.opts.queue
        })), c
    ...
    T.Animation = T.extend(ve, {
        ...
        tweener: function(t, e) {
            for (var n, i = 0, o = (t = _(t) ? (e = t, ["*"]) : t.match(j)).length; i < o; i++) n = t[i], ve.tweeners[n] = ve.tweeners[n] || [], ve.tweeners[n].unshift(e)
        },
        prefilters: [function(t, e, n) {
            ...
            for (i in n.queue || (null == (s = T._queueHooks(t, "fx")).unqueued && (s.unqueued = 0, a = s.empty.fire, s.empty.fire = function() {
                ...
                for (i in h && 1 === t.nodeType && (n.overflow = [p.overflow, p.overflowX, p.overflowY], null == (c = m && m.display) && (c = Y.get(t, "display")), "none" === (u = T.css(t, "display")) && (c ? u = c : (at([t], !0), c = t.style.display || c, u = T.css(t, "display"), at([t]))), ("inline" === u || "inline-block" === u && null != c) && "none" === T.css(t, "float") && (l || (d.done(function() {
                        p.display = c
                ...
                })), l = me(g ? m[i] : 0, i, d), i in m || (m[i] = l.start, g && (l.end = l.start, l.start = 0))
        }],
        ...
        stop: function(o, t, r) {
            ...
            return "string" != typeof o && (r = t, t = o, o = void 0), t && !1 !== o && this.queue(o || "fx", []), this.each(function() {
                ...
                if (e) i[e] && i[e].stop && s(i[e]);
                    ...
                    for (e in i) i[e] && i[e].stop && de.test(e) && s(i[e]);
    ...
    }, ce = E.createElement("input"), ue = E.createElement("select").appendChild(E.createElement("option")), ce.type = "checkbox", y.checkOn = "" !== ce.value, y.optSelected = ue.selected, (ce = E.createElement("input")).value = "t", ce.type = "radio", y.radioValue = "t" === ce.value;
    ...
    T.fn.extend({
        ...
        attr: function(t, e, n) {
            ...
            if (3 !== r && 8 !== r && 2 !== r) return void 0 === t.getAttribute ? T.prop(t, e, n) : (1 === r && T.isXMLDoc(t) || (o = T.attrHooks[e.toLowerCase()] || (T.expr.match.bool.test(e) ? ye : void 0)), void 0 !== n ? null === n ? void T.removeAttr(t, e) : o && "set" in o && void 0 !== (i = o.set(t, n, e)) ? i : (t.setAttribute(e, n + ""), n) : o && "get" in o && null !== (i = o.get(t, e)) ? i : null == (i = T.find.attr(t, e)) ? void 0 : i)
        },
        attrHooks: {
            type: {
                set: function(t, e) {
    ...
    T.fn.extend({
        ...
        toggleClass: function(o, e) {
            ...
            return "boolean" == typeof e && s ? e ? this.addClass(o) : this.removeClass(o) : _(o) ? this.each(function(t) {
                ...
                var t, e, n, i;
                if (s)
                    for (e = 0, n = T(this), i = Ee(o); t = i[e++];) n.hasClass(t) ? n.removeClass(t) : n.addClass(t);
                else void 0 !== o && "boolean" != r || ((t = xe(this)) && Y.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || !1 === o ? "" : Y.get(this, "__className__") || ""))
            })
        },
        hasClass: function(t) {
            var e, n, i = 0;
            for (e = " " + t + " "; n = this[i++];)
                if (1 === n.nodeType && -1 < (" " + Ce(xe(n)) + " ").indexOf(e)) return !0;
            return !1
        }
    });
    var Te = /\r/g;
    ...
    T.extend(T.event, {
        trigger: function(t, e, n, i) {
            var o, r, s, a, l, c, u, h, d = [n || E],
                f = v.call(t, "type") ? t.type : t,
                p = v.call(t, "namespace") ? t.namespace.split(".") : [];
            if (r = h = s = n = n || E, 3 !== n.nodeType && 8 !== n.nodeType && !ke.test(f + T.event.triggered) && (-1 < f.indexOf(".") && (f = (p = f.split(".")).shift(), p.sort()), l = f.indexOf(":") < 0 && "on" + f, (t = t[T.expando] ? t : new T.Event(f, "object" == typeof t && t)).isTrigger = i ? 2 : 3, t.namespace = p.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = n), e = null == e ? [t] : T.makeArray(e, [t]), u = T.event.special[f] || {}, i || !u.trigger || !1 !== u.trigger.apply(n, e))) {
                if (!i && !u.noBubble && !g(n)) {
                    for (a = u.delegateType || f, ke.test(a + f) || (r = r.parentNode); r; r = r.parentNode) d.push(r), s = r;
                    s === (n.ownerDocument || E) && d.push(s.defaultView || s.parentWindow || x)
                }
                for (o = 0;
                    (r = d[o++]) && !t.isPropagationStopped();) h = r, t.type = 1 < o ? a : u.bindType || f, (c = (Y.get(r, "events") || {})[t.type] && Y.get(r, "handle")) && c.apply(r, e), (c = l && r[l]) && c.apply && K(r) && (t.result = c.apply(r, e), !1 === t.result && t.preventDefault());
                return t.type = f, i || t.isDefaultPrevented() || u._default && !1 !== u._default.apply(d.pop(), e) || !K(n) || l && _(n[f]) && !g(n) && ((s = n[l]) && (n[l] = null), T.event.triggered = f, t.isPropagationStopped() && h.addEventListener(f, Se), n[f](), t.isPropagationStopped() && h.removeEventListener(f, Se), T.event.triggered = void 0, s && (n[l] = s)), t.result
            }
        },
    ...
    Ue.href = Ae.href, T.extend({
        ...
        ajax: function(t, e) {
            ...
            var u, h, d, n, f, i, p, g, o, r, m = T.ajaxSetup({}, e),
                ...
                C = {
                    ...
                    getResponseHeader: function(t) {
                        ...
                        if (p) {
                            if (!n)
                                for (n = {}; e = ze.exec(d);) n[e[1].toLowerCase()] = e[2];
                            e = n[t.toLowerCase()]
                        }
            ...
            if (_.promise(C), m.url = ((t || m.url || Ae.href) + "").replace(Re, Ae.protocol + "//"), m.type = e.method || e.type || m.method || m.type, m.dataTypes = (m.dataType || "*").toLowerCase().match(j) || [""], null == m.crossDomain) {
                i = E.createElement("a");
                try {
    ...
    y.cors = !!Xe && "withCredentials" in Xe, y.ajax = Xe = !!Xe, T.ajaxTransport(function(o) {
        ...
        if (y.cors || Xe && !o.crossDomain) return {
            send: function(t, e) {
                ...
                r = function(t) {
                    return function() {
                        r && (r = s = i.onload = i.onerror = i.onabort = i.ontimeout = i.onreadystatechange = null, "abort" === t ? i.abort() : "error" === t ? "number" != typeof i.status ? e(0, "error") : e(i.status, i.statusText) : e(Ye[i.status] || i.status, i.statusText, "text" !== (i.responseType || "text") || "string" != typeof i.responseText ? {
                            binary: i.response
                        } : {
                            text: i.responseText
    ...
    T.ajaxSetup({
        ...
        if (s || "jsonp" === t.dataTypes[0]) return i = t.jsonpCallback = _(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s ? t[s] = t[s].replace(Je, "$1" + i) : !1 !== t.jsonp && (t.url += (Ie.test(t.url) ? "&" : "?") + t.jsonp + "=" + i), t.converters["script json"] = function() {
            return r || T.error(i + " was not called"), r[0]
        }, t.dataTypes[0] = "json", o = x[i], x[i] = function() {
            r = arguments
        }, n.always(function() {
            void 0 === o ? T(x).removeProp(i) : x[i] = o, t[i] && (t.jsonpCallback = e.jsonpCallback, Ge.push(i)), r && _(o) && o(r[0]), r = o = void 0
        }), "script"
        ...
        return "string" != typeof t ? [] : ("boolean" == typeof e && (n = e, e = !1), e || (y.createHTMLDocument ? ((i = (e = E.implementation.createHTMLDocument("")).createElement("base")).href = E.location.href, e.head.appendChild(i)) : e = E), r = !n && [], (o = A.exec(t)) ? [e.createElement(o[1])] : (o = vt([t], e, r), r && r.length && T(r).remove(), T.merge([], o.childNodes)));
        var i, o, r
    }, T.fn.load = function(t, e, n) {
        var i, o, r, s = this,
            a = t.indexOf(" ");
        return -1 < a && (i = Ce(t.slice(a)), t = t.slice(0, a)), _(e) ? (n = e, e = void 0) : e && "object" == typeof e && (o = "POST"), 0 < s.length && T.ajax({
            url: t,
            type: o || "GET",
            dataType: "html",
            data: e
    ...
    }, T.isArray = Array.isArray, T.parseJSON = JSON.parse, T.nodeName = k, T.isFunction = _, T.isWindow = g, T.camelCase = Q, T.type = w, T.now = Date.now, T.isNumeric = function(t) {
        var e = T.type(t);
...
function(t, e) {
    ...
    (H = t)[F = "mmenu"] && "6.1.8" < H[F].version || (H[F] = function(t, e, n) {
            ...
            if (this.trigger("openPanel:before", t), t && t.length && (t.is("." + $.panel) || (t = t.closest("." + $.panel)), t.is("." + $.panel))) {
                ...
                if ("boolean" != typeof e && (e = !0), t.hasClass($.vertical)) t.add(t.parents("." + $.vertical)).removeClass($.hidden).parent("li").addClass($.opened), this.openPanel(t.parents("." + $.panel).not("." + $.vertical).first()), this.trigger("openPanel:start", t), this.trigger("openPanel:finish", t);
                    ...
                    var i = this.$pnls.children("." + $.panel),
                        o = i.filter("." + $.opened);
                    if (!H[F].support.csstransitions) return o.addClass($.hidden).removeClass($.opened), t.removeClass($.hidden).addClass($.opened), this.trigger("openPanel:start", t), void this.trigger("openPanel:finish", t);
                    i.not(t).removeClass($.subopened);
                    for (var r = t.data(z.parent); r;)(r = r.closest("." + $.panel)).is("." + $.vertical) || r.addClass($.subopened), r = r.data(z.parent);
        ...
        _initPanel: function(t) {
            ...
            var i = t.parent("li");
            return e ? t.add(i).addClass($.vertical) : t.appendTo(this.$pnls), i.length && (i.data(z.child, t), t.data(z.parent, i)), this.trigger("initPanel:after", t), t
        },
        _initNavbar: function(t) {
            if (this.trigger("initNavbar:before", t), !t.children("." + $.navbar).length) {
                var e = t.data(z.parent),
                    n = H('<div class="' + $.navbar + '" />'),
                    i = H[F].i18n(this.opts.navbar.title),
                    o = "";
                if (e && e.length) {
                    if (e.hasClass($.vertical)) return;
                    if (e.parent().is("." + $.listview)) var r = e.children("a, span").not("." + $.next);
                    else r = e.closest("." + $.panel).find('a[href="#' + t.attr("id") + '"]');
        ...
        _initListview: function(t) {
            ...
            if (i && i.parent().is("." + $.listview) && !i.children("." + $.next).length) {
                var o = i.children("a, span").first(),
                    r = H('<a class="' + $.next + '" href="#' + t.attr("id") + '" />').insertBefore(o);
        ...
        _initAnchors: function() {
            ...
            R.$body.on(q.click + "-oncanvas", "a[href]", function(t) {
                ...
                for (var o in H[F].addons)
                    if (H[F].addons[o].clickAnchor.call(l, e, i)) {
                        n = !0;
                        break
                    } var r = e.attr("href");
        ...
        __transitionend: function(e, n, t) {
            function i(t) {
                void 0 !== t && t.target != e[0] || (o || (e.off(q.transitionend), e.off(q.webkitTransitionEnd), n.call(e[0])), o = !0)
            }
            var o = !1;
        ...
        H[F].glbl || (R = {
            ...
            return t + ".mm"
        }, q.add("transitionend webkitTransitionEnd click scroll resize keydown mousedown mouseup touchstart touchmove touchend orientationchange"), H[F]._c = $, H[F]._d = z, H[F]._e = q, H[F].glbl = R), n = H.extend(!0, {}, H[F].defaults, n), i = H.extend(!0, {}, H[F].configuration, i);
        var o = H();
        return this.each(function() {
            var t = H(this);
            if (!t.data(F)) {
        ...
        setup: function() {
            if (this.opts[M]) {
                var i = this,
                    t = this.opts[M],
                    o = this.conf[M];
                L = I[j].glbl, this._api = I.merge(this._api, ["open", "close", "setPage"]), "object" != typeof t && (t = {}), "top" != t.position && "bottom" != t.position || (t.zposition = "front"), t = this.opts[M] = I.extend(!0, {}, I[j].defaults[M], t), "string" != typeof o.pageSelector && (o.pageSelector = "> " + o.pageNodetype), this.vars.opened = !1;
                var r = [N.offcanvas];
                "left" != t.position && r.push(N.mm(t.position)), "back" != t.zposition && r.push(N.mm(t.zposition)), I[j].support.csstransforms || r.push(N["no-csstransforms"]), I[j].support.csstransforms3d || r.push(N["no-csstransforms3d"]), this.bind("initMenu:after", function() {
                    var t = this;
                    ...
                    for (var n = [N.mm("widescreen"), N.mm("iconbar")], t = 0; t < n.length; t++)
        ...
        k.$body.off(S.touchstart + "-" + D).on(S.touchstart + "-" + D, "." + T.panels + "> ." + T.panel, function(t) {
            k.$html.hasClass(T.opened) && (e || (e = !0, 0 === t.currentTarget.scrollTop ? t.currentTarget.scrollTop = 1 : t.currentTarget.scrollHeight === t.currentTarget.scrollTop + t.currentTarget.offsetHeight && --t.currentTarget.scrollTop, e = !1))
        ...
        setup: function() {
            ...
            _[C].glbl, "boolean" == typeof t && (t = {
                ...
                if (e && e.length) {
                    var n = e.children("." + b.next),
                        i = n.nextAll("span, a").first().text(),
                        o = _[C].i18n(s.text[n.parent().is("." + b.vertical) ? "toggleSubmenu" : "openSubmenu"]);
                ...
                function t(t) {
                    if (!this.opts.offCanvas || this.vars.opened) {
                        var e = Math.max(parseInt(this.$pnls.css("top"), 10), 0) || 0,
                            ...
                            i = 0;
                        this.$menu.addClass(h.measureheight), "auto" == o.height ? ((t = t || this.$pnls.children("." + h.opened)).is("." + h.vertical) && (t = t.parents("." + h.panel).not("." + h.vertical)), t.length || (t = this.$pnls.children("." + h.panel)), i = t.first().outerHeight()) : "highest" == o.height && this.$pnls.children().each(function() {
                            var t = r(this);
        ...
        setup: function() {
            ...
            if (p[m].glbl, void 0 !== u) {
                ...
                u.length && (p.each(u, function(t) {
                    var e = u[t];
                    "boolean" == typeof e && e && (e = {}), "object" != typeof e && (e = {}), void 0 === e.content && (e.content = ["prev", "title"]), e.content instanceof Array || (e.content = [e.content]), e = p.extend(!0, {}, c.opts.navbar, e);
                    var n = p('<div class="' + g.navbar + '" />'),
                        i = e.height;
                    "number" != typeof i && (i = 1), i = Math.min(4, Math.max(1, i)), n.addClass(g.navbar + "-size-" + i);
                    var o = e.position;
                    "bottom" != o && (o = "top"), d[o] || (d[o] = 0), d[o] += i, f[o] || (f[o] = p('<div class="' + g.navbars + "-" + o + '" />')), f[o].append(n);
                    for (var r = 0, s = 0, a = e.content.length; s < a; s++) {
                        var l = p[m].addons[v][e.content[s]] || !1;
                        l ? r += l.call(c, n, e, h) : ((l = e.content[s]) instanceof p || (l = p(e.content[s])), n.append(l))
                    }
...
function(t) {
            ...
            if (i)
                for (var o = 0, r = i.length; o < r; ++o) {
                    var s = i[o].match(/%(-|!)?([a-zA-Z]{1})(:[^;]+;)?/),
                        ...
                        c = s[3] || "",
                        u = null;
                    s = s[2], d.hasOwnProperty(s) && (u = d[s], u = Number(h[u])), null !== u && ("!" === l && (u = f(c, u)), "" === l && u < 10 && (u = "0" + u.toString()), t = t.replace(a, u.toString()))
                }
            return t = t.replace(/%%/, "%")
        }
    }
    ...
    function f(t, e) {
        var n = "s",
            i = "";
        return t && (n = 1 === (t = t.replace(/(:|;|\s)/gi, "").split(/\,/)).length ? t[0] : (i = t[0], t[1])), 1 < Math.abs(e) ? n : i
    }
...
function(t) {
    ...
    t.prototype = {
        ...
        updateItemHTML: function() {
            ...
            var e = t.type;
            if (f("BeforeChange", [g.currItem ? g.currItem.type : "", e]), g.currItem = t, !g.currTemplate[e]) {
            ...
            g.appendContent(i, e), t.preloaded = !0, f("Change", t), o = t.type, g.container.prepend(g.contentContainer), f("AfterChange")
        },
        ...
        if ("string" == typeof t)
            if ("open" === t) {
                ...
                n = i.items ? i.items[o] : (n = e, i.delegate && (n = n.find(i.delegate)), n.eq(o)), g._openClick({
                    mfpEl: n
                }, e, i)
            } else g.isOpen && g[t].apply(g, Array.prototype.slice.call(arguments, 1));
        else t = u.extend(!0, {}, t), a ? e.data("magnificPopup", t) : e[0].magnificPopup = t, g.addGroup(e, t);
        return e
    };
            ...
            getInline: function(t, e) {
                if (x(), t.src) {
                    ...
                    if (i.length) {
                        ...
                        o && o.tagName && (T || (E = n.hiddenClass, T = d(E), E = "mfp-" + E), S = i.after(T).detach().removeClass(E)), g.updateStatus("ready")
            ...
            getAjax: function(o) {
                ...
                var t = u.extend({
                    ...
                    success: function(t, e, n) {
                        ...
                        f("ParseAjax", i), g.appendContent(u(i.data), N), o.finished = !0, A(), g._setFocus(), setTimeout(function() {
                            g.wrap.addClass(w)
    ...
    u.magnificPopup.registerModule("image", {
        ...
        proto: {
            ...
            getImage: function(t, e) {
                var n = 0,
                    i = function() {
                        t && (t.img[0].complete ? (t.img.off(".mfploader"), t === g.currItem && (g._onImageHasSize(t), g.updateStatus("ready")), t.hasSize = !0, t.loaded = !0, f("ImageLoadComplete")) : ++n < 200 ? setTimeout(i, 100) : o())
                    },
                    o = function() {
                ...
                if (s.length) {
                    ...
                    a.className = "mfp-img", t.el && t.el.find("img").length && (a.alt = t.el.find("img").attr("alt")), t.img = u(a).on("load.mfploader", i).on("error.mfploader", o), a.src = t.src, s.is("img") && (t.img = t.img.clone()), 0 < (a = t.img[0]).naturalWidth ? t.hasSize = !0 : a.width || (t.hasSize = !1)
                }
                ...
                }, t), g.resizeImage(), t.hasSize ? (O && clearInterval(O), t.loadError ? (e.addClass("mfp-loading"), g.updateStatus("error", r.tError.replace("%url%", t.src))) : (e.removeClass("mfp-loading"), g.updateStatus("ready"))) : (g.updateStatus("loading"), t.loading = !0, t.hasSize || (t.imgHidden = !0, e.addClass("mfp-loading"), g.findImageSize(t))), e
            }
        }
    });
    var P;
    ...
    u.magnificPopup.registerModule("gallery", {
        ...
        proto: {
            initGallery: function() {
                ...
                v += " mfp-gallery", h(_ + t, function() {
                    ...
                    if (1 < g.items.length && r.arrows && !g.arrowLeft) {
                        var t = r.arrowMarkup,
                            e = g.arrowLeft = u(t.replace(/%title%/gi, r.tPrev).replace(/%dir%/gi, "left")).addClass(s),
                            n = g.arrowRight = u(t.replace(/%title%/gi, r.tNext).replace(/%dir%/gi, "right")).addClass(s);
                        e.click(function() {
                            g.prev()
                        }), n.click(function() {
                            g.next()
            ...
            preloadNearbyImages: function() {
                var t, e = g.st.gallery.preload,
                    n = Math.min(e[0], g.items.length),
...
function() {
    ...
    r.prototype.extend = function(t, e) {
        ...
        var n, i, o, r, s, a;
        for (r = (s = l(t)).getPropertyCSSValue(e), n = 0, i = (o = this.vendors).length; n < i; n++) a = o[n], r = r || s.getPropertyCSSValue("-" + a + "-" + e);
        return r
        ...
        var e, n, i, o, r;
        return n = t.getAttribute("data-wow-offset") || this.config.offset, o = (r = this.config.scrollContainer && this.config.scrollContainer.scrollTop || window.pageYOffset) + Math.min(this.element.clientHeight, this.util().innerHeight()) - n, e = (i = this.offsetTop(t)) + t.clientHeight, i <= o && r <= e
    ...
    function(t, e) {
                ...
                return t.toggle = function() {
                    ...
                    if (n) {
                        ...
                        if (i) {
                            ...
                            t && (i.checked = !this._element.classList.contains(x), p(i).trigger("change")), i.focus(), e = !1
                        }
                    }
                    this._element.hasAttribute("disabled") || this._element.classList.contains("disabled") || (e && this._element.setAttribute("aria-pressed", !this._element.classList.contains(x)), t && p(this._element).toggleClass(x))
                }, t.dispose = function() {
        ...
        var j = "carousel",
            ...
            ut = function() {
                ...
                return t.next = function() {
                    ...
                    if (o = t === W ? (n = Z, i = G, B) : (n = X, i = J, U), l && p(l).hasClass(V)) this._isSliding = !1;
                    ...
                    if (e) {
                        ...
                        if (n && p(n).hasClass(K)) {
                            ...
                            o && (i.interval = !1), r._jQueryInterface.call(p(n), i), o && p(n).data(M).to(o), t.preventDefault()
                        }
                    }
                }, s(r, null, [{
                    key: "VERSION",
                ...
                return t.toggle = function() {
                    ...
                    if (!this._isTransitioning && !p(this._element).hasClass(yt) && (this._parent && 0 === (t = [].slice.call(this._parent.querySelectorAll(Et)).filter(function(t) {
                        ...
                        if (p(this._element).trigger(i), !i.isDefaultPrevented()) {
                            ...
                            p(this._element).removeClass(_t).addClass(bt), this._element.style[o] = 0, this._triggerArray.length && p(this._triggerArray).removeClass(wt).attr("aria-expanded", !0), this.setTransitioning(!0);
                            var r = "scroll" + (o[0].toUpperCase() + o.slice(1)),
                                s = g.getTransitionDurationFromElement(this._element);
                            p(this._element).one(g.TRANSITION_END, function() {
                                p(n._element).removeClass(bt).addClass(_t).addClass(yt), n._element.style[o] = "", n.setTransitioning(!1), p(n._element).trigger(vt.SHOWN)
        ...
        var kt = "undefined" != typeof window && "undefined" != typeof document && "undefined" != typeof navigator,
            At = function() {
                for (var t = ["Edge", "Trident", "Firefox"], e = 0; e < t.length; e += 1)
                    if (kt && 0 <= navigator.userAgent.indexOf(t[e])) return 1;
                return 0
            }();
        ...
        var jt = kt && !(!window.MSInputMethodContext || !document.documentMode),
            Mt = kt && /MSIE 10/.test(navigator.userAgent);
        ...
        function se(t, n, e) {
            return (void 0 === e ? t : t.slice(0, function(t, e, n) {
                ...
                t.enabled && It(e) && (n.offsets.popper = Yt(n.offsets.popper), n.offsets.reference = Yt(n.offsets.reference), n = e(n, t))
            }), n
        }
        ...
        function fe(n, i) {
            Object.keys(i).forEach(function(t) {
                var e = ""; - 1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(t) && de(i[t]) && (e = "px"), n.style[t] = i[t] + e
            })
        }
        ...
        function _e(t, e) {
            var n = 1 < arguments.length && void 0 !== e && e,
                i = ye.indexOf(t),
                o = ye.slice(i + 1).concat(ye.slice(0, i));
                ...
                modifiers: {
                    ...
                    offset: {
                        ...
                        fn: function(t, e) {
                            var n = e.offset,
                                ...
                                a = i.split("-")[0],
                                l = void 0;
                            return l = de(+n) ? [+n, 0] : xe(n, r, s, a), "left" === a ? (r.top += l[0], r.left -= l[1]) : "right" === a ? (r.top += l[0], r.left += l[1]) : "top" === a ? (r.left += l[0], r.top -= l[1]) : "bottom" === a && (r.left += l[0], r.top += l[1]), t.popper = r, t
                        },
                        offset: 0
                    },
                    preventOverflow: {
                    ...
                    arrow: {
                        ...
                        fn: function(t, e) {
                            ...
                            var o = t.placement.split("-")[0],
                                ...
                                f = l ? "bottom" : "right",
                                p = ne(i)[c];
                            a[f] - p < s[h] && (t.offsets.popper[h] -= s[h] - (a[f] - p)), a[h] + p > s[f] && (t.offsets.popper[h] += a[h] + p - s[f]), t.offsets.popper = Yt(t.offsets.popper);
                            var g = a[h] + a[c] / 2 - p / 2,
                                m = Nt(t.instance.popper),
                                v = parseFloat(m["margin" + u], 10),
                                y = parseFloat(m["border" + u + "Width"], 10),
                                _ = g - t.offsets.popper[h] - v - y;
                            return _ = Math.max(Math.min(s[c] - p, _), 0), t.arrowElement = i, t.offsets.arrow = (Kt(n = {}, h, Math.round(_)), Kt(n, d, ""), n), t
                        },
                        element: "[x-arrow]"
                    },
                    flip: {
                        ...
                        fn: function(m, v) {
                            ...
                            var y = Jt(m.instance.popper, m.instance.reference, v.padding, v.boundariesElement, m.positionFixed),
                            ...
                            return C.forEach(function(t, e) {
                                ...
                                var n, i = m.offsets.popper,
                                    ...
                                    g = f || p;
                                (s || h || g) && (m.flipped = !0, (s || h) && (_ = C[e + 1]), g && (w = "end" === (n = w) ? "start" : "start" === n ? "end" : n), m.placement = _ + (w ? "-" + w : ""), m.offsets.popper = Vt({}, m.offsets.popper, oe(m.instance.popper, m.offsets.reference, m.placement)), m = se(m.instance.modifiers, m, "flip"))
                            }), m
                        },
                        behavior: "flip",
                        padding: 5,
                    ...
                    inner: {
                        ...
                        fn: function(t) {
                            ...
                            return o[s ? "left" : "top"] = r[n] - (a ? o[s ? "width" : "height"] : 0), t.placement = ie(e), t.offsets.popper = Yt(o), t
                        }
                    },
                    hide: {
                        order: 800,
                        ...
                        fn: function(t) {
                            ...
                            var e = t.offsets.reference,
                                n = re(t.instance.modifiers, function(t) {
                    ...
                    computeStyle: {
                        ...
                        fn: function(t, e) {
                            var n = e.x,
                                i = e.y,
                                o = t.offsets.popper,
                                r = re(t.instance.modifiers, function(t) {
                                    return "applyStyle" === t.name
                                }).gpuAcceleration;
                            void 0 !== r && console.warn("WARNING: `gpuAcceleration` option moved to `computeStyle` modifier and will not be supported in future versions of Popper.js!");
                            var s = void 0 !== r ? r : e.gpuAcceleration,
                                a = $t(t.instance.popper),
                                l = Xt(a),
                                c = {
                                    position: o.position
                                },
                                u = pe(t, window.devicePixelRatio < 2 || !ge),
                    ...
                    applyStyle: {
                        ...
                        fn: function(t) {
                            var e, n;
                            return fe(t.instance.popper, t.styles), e = t.instance.popper, n = t.attributes, Object.keys(n).forEach(function(t) {
                                !1 !== n[t] ? e.setAttribute(t, n[t]) : e.removeAttribute(t)
                            }), t.arrowElement && Object.keys(t.arrowStyles).length && fe(t.arrowElement, t.arrowStyles), t
                        },
                        onLoad: function(t, e, n, i, o) {
                            var r = ee(o, e, t, n.positionFixed),
                                s = te(n.placement, r, e, t, n.modifiers.flip.boundariesElement, n.modifiers.flip.padding);
                ...
                value: function() {
                    return function() {
                        if (!this.state.isDestroyed) {
                            ...
                            t.offsets.reference = ee(this.state, this.popper, this.reference, this.options.positionFixed), t.placement = te(this.options.placement, t.offsets.reference, this.popper, this.reference, this.options.modifiers.flip.boundariesElement, this.options.modifiers.flip.padding), t.originalPlacement = t.placement, t.positionFixed = this.options.positionFixed, t.offsets.popper = oe(this.popper, t.offsets.reference, t.placement), t.offsets.popper.position = this.options.positionFixed ? "fixed" : "absolute", t = se(this.modifiers, t), this.state.isCreated ? this.options.onUpdate(t) : (this.state.isCreated = !0, this.options.onCreate(t))
                        }
                    }.call(this)
                }
            }, {
        ...
        function Se(t, e) {
            ...
            }, this.update = Dt(this.update.bind(this)), this.options = Vt({}, Se.Defaults, i), this.state = {
                isDestroyed: !1,
                isCreated: !1,
                scrollParents: []
            }, this.reference = t && t.jquery ? t[0] : t, this.popper = e && e.jquery ? e[0] : e, this.options.modifiers = {}, Object.keys(Vt({}, Se.Defaults.modifiers, i.modifiers)).forEach(function(t) {
        ...
        Te.Utils = ("undefined" != typeof window ? window : global).PopperUtils, Te.placements = ve, Te.Defaults = Ee;
        var ke = "dropdown",
            Ae = "bs.dropdown",
            De = "." + Ae,
            Ie = ".data-api",
            ...
            tn = function() {
                ...
                return t.toggle = function() {
                    ...
                    if (void 0 === t && (t = !1), !(this._element.disabled || p(this._element).hasClass(Le) || p(this._menu).hasClass(je))) {
                        ...
                        if (p(i).trigger(n), !n.isDefaultPrevented()) {
                            if (!this._inNavbar && t) {
                                ...
                                var o = this._element;
                                "parent" === this._config.reference ? o = i : g.isElement(this._config.reference) && (o = this._config.reference, void 0 !== this._config.reference.jquery && (o = this._config.reference[0])), "scrollParent" !== this._config.boundary && p(i).addClass(qe), this._popper = new Te(o, this._menu, this._getPopperConfig())
                            }
                            "ontouchstart" in document.documentElement && 0 === p(i).closest(Be).length && p(document.body).children().on("mouseover", null, p.noop), this._element.focus(), this._element.setAttribute("aria-expanded", !0), p(this._menu).toggleClass(je), p(i).toggleClass(je).trigger(p.Event(Pe.SHOWN, e))
                        }
                    }
                }, t.hide = function() {
                    if (!this._element.disabled && !p(this._element).hasClass(Le) && p(this._menu).hasClass(je)) {
                        ...
                        p(n).trigger(e), e.isDefaultPrevented() || (this._popper && this._popper.destroy(), p(this._menu).toggleClass(je), p(n).toggleClass(je).trigger(p.Event(Pe.HIDDEN, t)))
                    }
                }, t.dispose = function() {
                    p.removeData(this._element, Ae), p(this._element).off(De), this._element = null, (this._menu = null) !== this._popper && (this._popper.destroy(), this._popper = null)
                }, t.update = function() {
                    ...
                    var t = p(this._element.parentNode),
                        e = Ve;
                    return t.hasClass(Me) ? (e = Qe, p(this._menu).hasClass(ze) && (e = Ke)) : t.hasClass(He) ? e = Xe : t.hasClass($e) ? e = Ze : p(this._menu).hasClass(ze) && (e = Ye), e
                    ...
                    return this.each(function() {
                        ...
                        if (t || (t = new c(this, "object" == typeof e ? e : null), p(this).data(Ae, t)), "string" == typeof e) {
                        ...
                        for (var e = [].slice.call(document.querySelectorAll(Re)), n = 0, i = e.length; n < i; n++) {
                            ...
                            if (t && "click" === t.type && (s.clickEvent = t), r) {
                                ...
                                if (p(o).hasClass(je) && !(t && ("click" === t.type && /input|textarea/i.test(t.target.tagName) || "keyup" === t.type && 9 === t.which) && p.contains(o, t.target))) {
                                    ...
                                    p(o).trigger(l), l.isDefaultPrevented() || ("ontouchstart" in document.documentElement && p(document.body).children().off("mouseover", null, p.noop), e[n].setAttribute("aria-expanded", "false"), r._popper && r._popper.destroy(), p(a).removeClass(je), p(o).removeClass(je).trigger(p.Event(Pe.HIDDEN, s)))
                                }
                            }
                        }
                    ...
                    if ((/input|textarea/i.test(t.target.tagName) ? !(32 === t.which || 27 !== t.which && (40 !== t.which && 38 !== t.which || p(t.target).closest(Fe).length)) : Oe.test(t.which)) && (t.preventDefault(), t.stopPropagation(), !this.disabled && !p(this).hasClass(Le))) {
        ...
        var en = "modal",
            ...
            mn = ".modal-dialog",
            vn = ".modal-body",
            yn = '[data-toggle="modal"]',
            _n = '[data-dismiss="modal"]',
            bn = ".fixed-top, .fixed-bottom, .is-fixed, .sticky-top",
            wn = ".sticky-top",
            Cn = function() {
                function o(t, e) {
                    this._config = this._getConfig(e), this._element = t, this._dialog = t.querySelector(mn), this._backdrop = null, this._isShown = !1, this._isBodyOverflowing = !1, this._ignoreBackdropClick = !1, this._isTransitioning = !1, this._scrollbarWidth = 0
                }
                var t = o.prototype;
                return t.toggle = function(t) {
                    ...
                    if (!this._isShown && !this._isTransitioning) {
                        ...
                        p(this._element).trigger(n), this._isShown || n.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), this._adjustDialog(), this._setEscapeEvent(), this._setResizeEvent(), p(this._element).on(ln.CLICK_DISMISS, _n, function(t) {
                            return e.hide(t)
                    ...
                    var e = this,
                        n = p(this._element).hasClass(fn),
                        i = this._dialog ? this._dialog.querySelector(vn) : null;
                    this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element), this._element.style.display = "block", this._element.removeAttribute("aria-hidden"), this._element.setAttribute("aria-modal", !0), p(this._dialog).hasClass(cn) && i ? i.scrollTop = 0 : this._element.scrollTop = 0, n && g.reflow(this._element), p(this._element).addClass(pn), this._config.focus && this._enforceFocus();
                    ...
                    var e = this,
                        n = p(this._element).hasClass(fn) ? fn : "";
                    if (this._isShown && this._config.backdrop) {
                        if (this._backdrop = document.createElement("div"), this._backdrop.className = hn, n && this._backdrop.classList.add(n), p(this._backdrop).appendTo(document.body), p(this._element).on(ln.CLICK_DISMISS, function(t) {
                    ...
                    if (this._isBodyOverflowing) {
                        var t = [].slice.call(document.querySelectorAll(bn)),
                            e = [].slice.call(document.querySelectorAll(wn));
                    ...
                    return this.each(function() {
                        var t = p(this).data(nn),
                            e = l({}, sn, {}, p(this).data(), {}, "object" == typeof n && n ? n : {});
            ...
            Yn = function() {
                ...
                return t.enable = function() {
                    ...
                    if (this.isWithContent() && this._isEnabled) {
                        ...
                        o.setAttribute("id", r), this.element.setAttribute("aria-describedby", r), this.setContent(), this.config.animation && p(o).addClass(Rn);
                        var s = "function" == typeof this.config.placement ? this.config.placement.call(this, o, this.element) : this.config.placement,
                            a = this._getAttachment(s);
                        this.addAttachmentClass(a);
                        var l = this._getContainer();
                        p(o).data(this.constructor.DATA_KEY, this), p.contains(this.element.ownerDocument.documentElement, this.tip) || p(o).appendTo(l), p(this.element).trigger(this.constructor.Event.INSERTED), this._popper = new Te(this.element, o, this._getPopperConfig(a)), p(o).addClass(Wn), "ontouchstart" in document.documentElement && p(document.body).children().on("mouseover", null, p.noop);
                        var c = function() {
                    ...
                    function e() {
                        n._hoverState !== $n && i.parentNode && i.parentNode.removeChild(i), n._cleanTipClass(), n.element.removeAttribute("aria-describedby"), p(n.element).trigger(n.constructor.Event.HIDDEN), null !== n._popper && n._popper.destroy(), t && t()
                    }
                    var n = this,
                        i = this.getTipElement(),
                        o = p.Event(this.constructor.Event.HIDE);
                    if (p(this.element).trigger(o), !o.isDefaultPrevented()) {
                        if (p(i).removeClass(Wn), "ontouchstart" in document.documentElement && p(document.body).children().off("mouseover", null, p.noop), this._activeTrigger[Kn] = !1, this._activeTrigger[Qn] = !1, this._activeTrigger[Un] = !1, p(this.tip).hasClass(Rn)) {
                    ...
                    var n = this.constructor.DATA_KEY;
                    (e = e || p(t.currentTarget).data(n)) || (e = new this.constructor(t.currentTarget, this._getDelegateConfig()), p(t.currentTarget).data(n, e)), t && (e._activeTrigger["focusout" === t.type ? Qn : Un] = !1), e._isWithActiveTrigger() || (clearTimeout(e._timeout), e._hoverState = zn, e.config.delay && e.config.delay.hide ? e._timeout = setTimeout(function() {
                    ...
                    return Object.keys(e).forEach(function(t) {
                        ...
                        show: t.delay,
                        hide: t.delay
                    }), "number" == typeof t.title && (t.title = t.title.toString()), "number" == typeof t.content && (t.content = t.content.toString()), g.typeCheckConfig(An, t, this.constructor.DefaultType), t.sanitize && (t.template = kn(t.template, t.whiteList, t.sanitizeFn)), t
                    ...
                    null === t.getAttribute("x-placement") && (p(t).removeClass(Rn), this.config.animation = !1, this.hide(), this.show(), this.config.animation = e)
                }, i._jQueryInterface = function(n) {
                    return this.each(function() {
                        var t = p(this).data(Dn),
                            e = "object" == typeof n && n;
                        if ((t || !/dispose|hide/.test(n)) && (t || (t = new i(this, e), p(this).data(Dn, t)), "string" == typeof n)) {
                            if (void 0 === t[n]) throw new TypeError('No method named "' + n + '"');
                            t[n]()
                        }
                    })
        ...
        var Xn = "popover",
            ...
            ci = function(t) {
                ...
                return o.isWithContent = function() {
                    ...
                    "function" == typeof e && (e = e.call(this.element)), this.setElementContent(t.find(ai), e), t.removeClass(oi + " " + ri)
                    ...
                    return this.each(function() {
                        var t = p(this).data(Zn),
                            e = "object" == typeof n ? n : null;
                        if ((t || !/dispose|hide/.test(n)) && (t || (t = new i(this, e), p(this).data(Zn, t)), "string" == typeof n)) {
                            if (void 0 === t[n]) throw new TypeError('No method named "' + n + '"');
                            t[n]()
                        }
                    })
        ...
        var ui = "scrollspy",
            ...
            Di = function() {
                function n(t, e) {
                    var n = this;
                    this._element = t, this._scrollElement = "BODY" === t.tagName ? window : t, this._config = this._getConfig(e), this._selector = this._config.target + " " + wi + "," + this._config.target + " " + xi + "," + this._config.target + " " + Ti, this._offsets = [], this._targets = [], this._activeTarget = null, this._scrollHeight = 0, p(this._scrollElement).on(mi.SCROLL, function(t) {
                        return n._process(t)
                ...
                return t.refresh = function() {
                    var e = this,
                        t = this._scrollElement === this._scrollElement.window ? ki : Ai,
                    ...
                    p.removeData(this._element, hi), p(this._scrollElement).off(di), this._element = null, this._scrollElement = null, this._config = null, this._selector = null, this._offsets = null, this._targets = null, this._activeTarget = null, this._scrollHeight = null
                }, t._getConfig = function(t) {
                    ...
                    n.hasClass(vi) ? (n.closest(Ei).find(Si).addClass(yi), n.addClass(yi)) : (n.addClass(yi), n.parents(bi).prev(wi + ", " + xi).addClass(yi), n.parents(bi).prev(Ci).children(wi).addClass(yi)), p(this._scrollElement).trigger(mi.ACTIVATE, {
                        relatedTarget: e
                    })
                }, t._clear = function() {
            ...
            Qi = function() {
                ...
                return t.show = function() {
                    ...
                    if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && p(this._element).hasClass(ji) || p(this._element).hasClass(Mi))) {
                        var t, i, e = p(this._element).closest(qi)[0],
                    ...
                    var o = this,
                        r = (!e || "UL" !== e.nodeName && "OL" !== e.nodeName ? p(e).children(Ri) : p(e).find(Wi))[0],
                        s = n && r && p(r).hasClass(Hi);
                    if (r && s) {
                    ...
                    if (p(t).addClass(ji), "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !0), g.reflow(t), t.classList.contains(Hi) && t.classList.add($i), t.parentNode && p(t.parentNode).hasClass(Li)) {
            ...
            ro = function() {
                ...
                return t.show = function() {
                    ...
                    if (p(this._element).trigger(e), !e.isDefaultPrevented()) {
                        ...
                        var n = function() {
                            t._element.classList.remove(eo), t._element.classList.add(to), p(t._element).trigger(Zi.SHOWN), t._config.autohide && (t._timeout = setTimeout(function() {
                                t.hide()
                            }, t._config.delay))
                        };
                        if (this._element.classList.remove(Ji), g.reflow(this._element), this._element.classList.add(eo), this._config.animation) {
                    ...
                    clearTimeout(this._timeout), this._timeout = null, this._element.classList.contains(to) && this._element.classList.remove(to), p(this._element).off(Zi.CLICK_DISMISS), p.removeData(this._element, Vi), this._element = null, this._config = null
                }, t._getConfig = function(t) {
                    return t = l({}, io, {}, p(this._element).data(), {}, "object" == typeof t && t ? t : {}), g.typeCheckConfig(Ki, t, this.constructor.DefaultType), t
                }, t._setListeners = function() {
                    var t = this;
        ...
        }, t.Alert = v, t.Button = L, t.Carousel = ut, t.Collapse = St, t.Dropdown = tn, t.Modal = Cn, t.Popover = ci, t.Scrollspy = Di, t.Tab = Qi, t.Toast = ro, t.Tooltip = Yn, t.Util = g, Object.defineProperty(t, "__esModule", {
            value: !0
        })
    }),
    function(t) {
    ...
    function(r) {
        r.fn.niceSelect = function(t) {
            ...
            this.hide(), this.each(function() {
                ...
                var e = r(this),
                    n = r(e.find(".focus") || e.find(".list .option.selected"));
                if (32 == t.keyCode || 13 == t.keyCode) return e.hasClass("open") ? n.trigger("click") : e.trigger("click"), !1;
                if (40 == t.keyCode) {
                    if (e.hasClass("open")) {
